...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\DELL\Documents\Python_Test_Projects\Images_GUI\loginBg.jpg")
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=0,y=0, relwidth=1,relheight=1)

        frame1= Frame(self.root,bg="#288da8")
        frame1.place(x=560,y=170,width=340,height=450)

        img1=Image.open(r"C:\Users\DELL\Documents\Python_Test_Projects\Images_GUI\log1.png")
        img1=img1.resize((100,100),Image.Resampling.LANCZOS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        lb1img1 = Label(image=self.photoimage1,bg="#FFFFFF")
        lb1img1.place(x=690,y=175, width=100,height=100)

        get_str = Label(frame1,text="Login",font=("times new roman",20,"bold"),fg="white",bg="#288da8")
        get_str.place(x=140,y=100)

        #label1 
        username =lb1= Label(frame1,text="Username:",font=("times new roman",15,"bold"),fg="white",bg="#288da8")
        ...
        #label2 
        pwd =lb1= Label(frame1,text="Password:",font=("times new roman",15,"bold"),fg="white",bg="#288da8")
        ...
        loginbtn=Button(frame1,command=self.login,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#288da8",bg="white",activeforeground="white",activebackground="#007ACC")
        loginbtn.place(x=33,y=320,width=270,height=35)


        # Creating Button Registration
        loginbtn=Button(frame1,command=self.reg,text="Register",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="white",bg="#288da8",activeforeground="orange",activebackground="#288da8")
        loginbtn.place(x=33,y=370,width=50,height=20)


        # Creating Button Forget
        loginbtn=Button(frame1,command=self.forget_pwd,text="Forget",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="white",bg="#288da8",activeforeground="orange",activebackground="#288da8")
    ...
    def forget_pwd(self):
        if self.txtuser.get()=="":
            ...
            if row==None:
                ...
                l=Label(self.root2,text="Forget Password",font=("times new roman",30,"bold"),fg="#288da8",bg="#fff")
                l.place(x=0,y=10,relwidth=1)
                # -------------------fields-------------------
                #label1 
                ssq =lb1= Label(self.root2,text="Select Security Question:",font=("times new roman",15,"bold"),fg="#288da8",bg="#F2F2F2")
                ssq.place(x=70,y=80)
                ...
                #label2 
                sa =lb1= Label(self.root2,text="Security Answer:",font=("times new roman",15,"bold"),fg="#288da8",bg="#F2F2F2")
                sa.place(x=70,y=150)
                ...
                #label2 
                new_pwd =lb1= Label(self.root2,text="New Password:",font=("times new roman",15,"bold"),fg="#288da8",bg="#F2F2F2")
                ...
                loginbtn=Button(self.root2,command=self.reset_pass,text="Reset Password",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#288da8",activeforeground="white",activebackground="#007ACC")
...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"C:\Users\DELL\Documents\Python_Test_Projects\Images_GUI\banner.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\DELL\Documents\Python_Test_Projects\Images_GUI\bg3.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\DELL\Documents\Python_Test_Projects\Images_GUI\std1.jpg")
        ...
        det_img_btn=Image.open(r"C:\Users\DELL\Documents\Python_Test_Projects\Images_GUI\det1.jpg")
        ...
        att_img_btn=Image.open(r"C:\Users\DELL\Documents\Python_Test_Projects\Images_GUI\att.jpg")
        ...
        hlp_img_btn=Image.open(r"C:\Users\DELL\Documents\Python_Test_Projects\Images_GUI\hlp.jpg")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"C:\Users\DELL\Documents\Python_Test_Projects\Images_GUI\tra1.jpg")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"C:\Users\DELL\Documents\Python_Test_Projects\Images_GUI\qr1.png")
        ...
        # Developers   button 7
        dev_img_btn=Image.open(r"C:\Users\DELL\Documents\Python_Test_Projects\Images_GUI\dev.jpg")
        ...
        # exit   button 8
        exi_img_btn=Image.open(r"C:\Users\DELL\Documents\Python_Test_Projects\Images_GUI\exi.jpg")
