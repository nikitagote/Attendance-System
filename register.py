...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\DELL\Documents\Python_Test_Projects\Images_GUI\bgReg.jpg")
        ...
        get_str = Label(frame,text="Registration",font=("times new roman",30,"bold"),fg="#288da8",bg="#F2F2F2")
        get_str.place(x=350,y=130)

        #label1 
        fname =lb1= Label(frame,text="First Name:",font=("times new roman",15,"bold"),fg="#288da8",bg="#F2F2F2")
        ...
        #label2 
        lname =lb1= Label(frame,text="Last Name:",font=("times new roman",15,"bold"),fg="#288da8",bg="#F2F2F2")
        ...
        #label1 
        cnum =lb1= Label(frame,text="Contact No:",font=("times new roman",15,"bold"),fg="#288da8",bg="#F2F2F2")
        ...
        #label2 
        email =lb1= Label(frame,text="Email:",font=("times new roman",15,"bold"),fg="#288da8",bg="#F2F2F2")
        ...
        #label1 
        ssq =lb1= Label(frame,text="Select Security Question:",font=("times new roman",15,"bold"),fg="#288da8",bg="#F2F2F2")
        ...
        #label2 
        sa =lb1= Label(frame,text="Security Answer:",font=("times new roman",15,"bold"),fg="#288da8",bg="#F2F2F2")
        ...
        #label1 
        pwd =lb1= Label(frame,text="Password:",font=("times new roman",15,"bold"),fg="#288da8",bg="#F2F2F2")
        ...
        #label2 
        cpwd =lb1= Label(frame,text="Confirm Password:",font=("times new roman",15,"bold"),fg="#288da8",bg="#F2F2F2")
        ...
        # Checkbutton
        checkbtn = Checkbutton(frame,variable=self.var_check,text="I Agree the Terms & Conditions",font=("times new roman",13,"bold"),fg="#288da8",bg="#F2F2F2")
        checkbtn.place(x=100,y=480,width=270)


        # Creating Button Register
        loginbtn=Button(frame,command=self.reg,text="Register",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#288da8",activeforeground="white",activebackground="#007ACC")
        loginbtn.place(x=103,y=510,width=270,height=35)

        # Creating Button Login
        loginbtn=Button(frame,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#288da8",activeforeground="white",activebackground="#007ACC")
